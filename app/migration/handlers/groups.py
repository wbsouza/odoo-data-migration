...
from .base import DomainHandler, ResourceNotFoundException, DESTINATION
...
class ResGroupsHandler(DomainHandler):
    ...
    def group_exists(self, group_name: str) -> bool:
        ...
        """
        group_model = self._odoo_provider.get_odoo_connection(DESTINATION).get_model('res.groups')
    ...
    def save_into_destination(self, transformed_records: List[Dict]):
        ...
        for record in transformed_records:
            ...
            destination_model = self._odoo_provider.get_odoo_connection(DESTINATION).get_model(model_name)
